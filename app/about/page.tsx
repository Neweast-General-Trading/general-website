import { Crosshair, Gem, View } from "lucide-react";
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              <div className="space-y-6">
                ...
                <p className="text-gray-600">
                  ...
                  competitive pricing, and exceptional customer service within
                  the aftermarket sector. Today, we proudly rank among the
                  foremost automotive parts distributors on a global scale. Our
                  unwavering focus on meeting customer needs shines through our
                  extensive selection of high-quality auto parts, our commitment
                  to building strong client relationships, and our
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div className="space-y-6">
                ...
                <p className="text-gray-600">
                  ...
                  including phone, email, and online platforms such as our
                  website and social media channels.
                </p>
                <p className="text-gray-600">
                  Whether in Europe, the Middle East, or Southeast Asia, Neweast
                  General Trading is your trusted partner for all your
                  aftermarket automotive parts needs. Explore a world of quality
                  and reliability with us.
                </p>
              </div>
              <div>
                <Image
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              <div className="space-y-6">
                ...
                <p className="text-gray-600">
                  ...
                  distributor, providing dealers with a seamless resource for
                  all their automotive spare parts needs and facilitating their
                  business growth.
                </p>
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div className="space-y-6">
                ...
                <p className="text-gray-600">
                  ...
                  highly motivated individuals passionate about their work,
                  mainly when delivering genuine customer support.
                </p>
              </div>
              <div>
                <Image
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-white p-6 rounded-sm">
                ...
                <p className="text-gray-600">
                  Rooted in solid values and guided by dedicated leadership, it
                  is to uphold and build upon the foundation laid by the
                  company’s founders. We remain steadfast in our commitment to
                  elevate productivity and provide high-quality, value-added
                  services.
                </p>
              </div>
              ...
              <div className="bg-white p-6 rounded-sm">
                ...
                <p className="text-gray-600">
                  ...
                  cultivate trust among our valued customers, dedicated
              ...
              <div className="bg-white p-6 rounded-sm">
                ...
                <p className="text-gray-600">
                  ...
                  through integrity, honesty, and continuous skill improvement
                  to meet their needs.
                </p>
              </div>
            </div>
